...
class _BaseHMM(BaseEstimator):
    ...
    def score_modified(self, X, lengths=None, fq_c=None):
        ...
        logprob = 0
        for i, j in iter_from_X_lengths(X, lengths):
            frameprob = self.emissionprob_[:, np.concatenate(X[i:j])].T
    ...
    def _forward(self, n_samples, n_components,
                 log_startprob,
                 log_transmat,
                 framelogprob,
                 fwdlattice):
    ...
    def _forward_modified_v1(self, n_samples, n_components,
                 startprob,
                 transmat,
                 frameprob,
                 fwdlattice):
    ...
    def _do_forward_pass(self, framelogprob):
        ...
        self._forward(n_samples, n_components,
